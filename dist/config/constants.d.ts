...
export declare const DEFAULT_SHEET_TAB = "Draft Quote Sales Touch";
export declare const DEFAULT_QUOTE_LIMIT = 100;
export declare const DEFAULT_QUOTE_PAGE_SIZE = 5;
...
export declare const DEFAULT_JOBBER_REQUEST_DELAY_MS = 750;
export declare const DEFAULT_JOBBER_NOTES_PAGE_SIZE = 20;
